      ...
      <div className="row" style={{ marginBottom: "3%" }}>
        ...
        <div className="col-md-6">
          <h5 className="text-justify">
            ...
            represented in their home state and which ones should be lobbied for
            in regards to being addressed. This website will also highlight
            which issues on a nation-wide scale are being discussed and which
