...
class SourceCard extends Component {
  ...
  <div className="card mb-4 box-shadow text-center">
    <img className="card-img-top about-image mx-auto" style={{minHeight: 240, padding: 20}} src={source.image} alt="{source.name}"></img>
    <div className="card-body">
      <h5><a href={source.url}>{source.name}</a></h5>
      <p>
