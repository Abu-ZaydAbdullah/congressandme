export default [
  {
    ...
    description: "Food ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/farming.jpg",
    issue_id: 2,
    name: "Agriculture",
  ...
  },
  {
    ...
    description: "Crime  ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/crime.jpg",
    issue_id: 4,
  ...
  },
  {
    ...
    description: "1+1 = ?",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/college.jpg",
    issue_id: 6,
    name: "Education",
  ...
  },
  {
    ...
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/emergency.jpg",
    issue_id: 7,
  ...
  },
  {
    ...
    description: "Earth ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/nature.jpg",
    issue_id: 8,
  ...
  },
  {
    ...
    description: "Weapons ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/gun.jpg",
    issue_id: 9,
    name: "Gun Control",
  ...
  },
  {
    ...
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/medical.jpg",
    issue_id: 10,
    name: "Healthcare",
  ...
  },
  {
    ...
    description: "Homlessness/Gentrification/Rent/Growth ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/housing.jpg",
    issue_id: 11,
  ...
  },
  {
    ...
    description: "Global-Movement ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/fence.jpg",
    issue_id: 12,
    name: "Immigration",
  ...
  },
  {
    ...
    about:
      "Wage labour (also wage labor in American English) is the socioeconomic relationship between a worker and an employer, where the worker sells their labour power under a formal or informal employment contract.[1] These transactions usually occur in a labour market where wages or salaries are market-determined. In exchange for the money paid as wages (usual for short-term work-contracts) or salaries (in permanent employment contracts), the work product generally becomes the undifferentiated property of the employer, except for special cases such as the vesting of intellectual property patents in the United States where patent rights are usually vested in the employee personally responsible for the invention. A wage labourer is a person whose primary means of income is from the selling of their labour in this way.",
    description: "Work ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/labor.jpg",
    issue_id: 13,
  ...
  },
  {
    ...
    description: "Ethics/Change/Rights ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/social.jpg",
    issue_id: 14,
    name: "Social Issues",
  ...
  },
  {
    ...
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/tax.jpg",
    issue_id: 15,
    name: "Taxation",
  ...
  },
  {
    ...
    about:
      "Transport or transportation is the movement of humans, animals and goods from one location to another. In other words, the action of transport is defined as a particular movement of an organism or thing from a point A to a Point B. Modes of transport include air, land (rail and road), water, cable, pipeline and space. The field can be divided into infrastructure, vehicles and operations. Transport enables trade between people, which is essential for the development of civilizations. Transport infrastructure consists of the fixed installations, including roads, railways, airways, waterways, canals and pipelines and terminals such as airports, railway stations, bus stations, warehouses, trucking terminals, refueling depots (including fueling docks and fuel stations) and seaports. Terminals may be used both for interchange of passengers and cargo and for maintenance. Vehicles traveling on these networks may include automobiles, bicycles, buses, trains, trucks, helicopters, watercraft, spacecraft and aircraft.",
    description: "Vehicles ",
    image:
      "https://congress-and-me.s3.us-east-2.amazonaws.com/static/media/issues/transportation.jpg",
    issue_id: 16,
