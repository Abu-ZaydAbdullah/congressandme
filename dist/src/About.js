...
},{"./_baseClone":"../node_modules/lodash/_baseClone.js"}],"../src/assets/david.jpeg":[function(require,module,exports) {
module.exports = "/990fe6fc7c4f18a03f975b23a22fe85e.jpeg";
},{}],"../src/assets/robert.png":[function(require,module,exports) {
module.exports = "/325df23ccf7a068f15fc77ac9ce0383f.png";
},{}],"../src/assets/abuzayd.png":[function(require,module,exports) {
module.exports = "/e1eeb39dec8a9b516de1c6113aa9a7a5.png";
},{}],"../src/assets/benb.png":[function(require,module,exports) {
module.exports = "/884465ea881ea41b019326169a4543eb.png";
},{}],"../src/assets/benh.jpeg":[function(require,module,exports) {
module.exports = "/adbbe54faad318a56bb18cc77df1f5ec.jpeg";
},{}],"../src/assets/calvin.jpg":[function(require,module,exports) {
module.exports = "/5225475161de56d16eb30c5c8a02b6ae.jpg";
},{}],"../src/data/GroupMembers.js":[function(require,module,exports) {
"use strict";
...
var _david = _interopRequireDefault(require("../assets/david.jpeg"));

var _robert = _interopRequireDefault(require("../assets/robert.png"));

var _abuzayd = _interopRequireDefault(require("../assets/abuzayd.png"));

var _benb = _interopRequireDefault(require("../assets/benb.png"));

var _benh = _interopRequireDefault(require("../assets/benh.jpeg"));

var _calvin = _interopRequireDefault(require("../assets/calvin.jpg"));
...
},{"../assets/david.jpeg":"../src/assets/david.jpeg","../assets/robert.png":"../src/assets/robert.png","../assets/abuzayd.png":"../src/assets/abuzayd.png","../assets/benb.png":"../src/assets/benb.png","../assets/benh.jpeg":"../src/assets/benh.jpeg","../assets/calvin.jpg":"../src/assets/calvin.jpg"}],"../src/components/AboutCard.js":[function(require,module,exports) {
"use strict";
...
var _GroupMembers = _interopRequireDefault(require("../data/GroupMembers"));
...
/*#__PURE__*/
function (_Component) {
  _inherits(AboutCard, _Component);
  ...
  function AboutCard(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AboutCard).call(this, props));
    _this.state = {
      commit_dict: {
        "Abu-Zayd Abdullah": 0,
        "Abu-ZaydAbdullah": 0,
  ...
  _createClass(AboutCard, [{
    ...
    value: function componentWillMount() {
      ...
      var getCommits = function getCommits() {
        ...
        while (currPage < 5) {
          var authOptions = {
            method: "GET",
            url: "https://gitlab.com/api/v4/projects/14525540/repository/commits?all=true&per_page=100&page=".concat(currPage),
            headers: {
              "Private-Token": "mS_bG_uQE4UkARaq3_oQ"
            },
            json: true
          };
          (0, _axios.default)(authOptions).then(function (response) {
            var responseData = response.data;
            responseData.forEach(function (commit) {
              _this2.setState({
                commit_count: _this2.state.commit_count + 1
              });

              var temp_commit_dict = (0, _cloneDeep.default)(_this2.state.commit_dict);
              temp_commit_dict[commit.author_name] += 1;

              _this2.setState({
                commit_dict: temp_commit_dict
              });
            });
            var temp_commit_dict = (0, _cloneDeep.default)(_this2.state.commit_dict);
      ...
      var getIssues = function getIssues() {
        ...
        (0, _axios.default)(authOptions).then(function (response) {
          ...
          responseData.forEach(function (issue) {
            _this2.setState({
              issue_count: _this2.state.issue_count + 1
            });

            if (issue.closed_by != null) {
              var _temp_issue_dict = (0, _cloneDeep.default)(_this2.state.issue_dict);

              _temp_issue_dict[issue.closed_by.name] += 1;

              _this2.setState({
                issue_dict: _temp_issue_dict
              });
            }
          });
          var temp_issue_dict = (0, _cloneDeep.default)(_this2.state.issue_dict);
          temp_issue_dict["Abu-Zayd Abdullah"] += temp_issue_dict["Abu-ZaydAbdullah"];

          _this2.setState({
            issue_dict: temp_issue_dict
          });
        });
      };
    ...
    value: function render() {
      ...
      var aboutList = _GroupMembers.default.map(function (member) {
        return _react.default.createElement("div", {
          ...
          className: "card-body"
        }, _react.default.createElement("h5", null, member.name), _react.default.createElement("p", null, _react.default.createElement("p", {
          className: "card-text"
        }, _react.default.createElement("strong", null, "Role: "), member.role), _react.default.createElement("p", {
          className: "card-text"
        }, _react.default.createElement("strong", null, "Biography: "), member.bio)), "\n", _react.default.createElement("p", {
          className: "card-text"
        }, _react.default.createElement("strong", null, "Commits: "), _this3.state.commit_dict[member.name]), _react.default.createElement("p", {
          className: "card-text"
        }, _react.default.createElement("strong", null, "Issues: "), _this3.state.issue_dict[member.name] != undefined ? _this3.state.issue_dict[member.name] : _this3.state.issue_dict[member.gitlab_id]), _react.default.createElement("p", {
          className: "card-text"
        }, _react.default.createElement("strong", null, "Unit Tests: "), _this3.state.unittest_dict[member.name]), _react.default.createElement("div", {
      ...
      return _react.default.createElement("div", {
        ...
        className: "row"
      }, aboutList, _react.default.createElement("div", {
        className: "col-md-4"
      }), _react.default.createElement("div", {
        className: "col-md-4"
      }, _react.default.createElement("div", {
        ...
        className: "card-body"
      }, _react.default.createElement("h5", null, "Team Stats"), _react.default.createElement("p", {
        className: "card-text"
      }), _react.default.createElement("p", {
        className: "card-text"
      }, _react.default.createElement("strong", null, "Total Commits:"), " ", this.state.commit_count), _react.default.createElement("p", {
        className: "card-text"
      }, _react.default.createElement("strong", null, "Total Issues:"), " ", this.state.issue_count), _react.default.createElement("p", {
        className: "card-text"
      }, _react.default.createElement("strong", null, "Total Unit Tests:"), " ", this.state.unittest_count)))), _react.default.createElement("div", {
        className: "col-md-4"
      })));
    }
  }]);
...
exports.default = _default;
},{"axios":"../node_modules/axios/index.js","lodash/cloneDeep":"../node_modules/lodash/cloneDeep.js","react":"../node_modules/react/index.js","../data/GroupMembers":"../src/data/GroupMembers.js"}],"../src/assets/aws.png":[function(require,module,exports) {
module.exports = "/b75fa40475c4cd8ae15157c47f88ee19.png";
},{}],"../src/assets/slack.jpg":[function(require,module,exports) {
module.exports = "/397931c688cfa0b9862a0f53fd055888.jpg";
},{}],"../src/assets/react.png":[function(require,module,exports) {
module.exports = "/7f9f407c0e9dd261525ce25e64c01fde.png";
},{}],"../src/assets/postman.png":[function(require,module,exports) {
module.exports = "/9dff992d5deeda6655fe0b46cad7bb8b.png";
},{}],"../src/assets/namecheap.png":[function(require,module,exports) {
module.exports = "/8bbfe8df296d32c66e9d326a149a0352.png";
},{}],"../src/assets/gitlab.png":[function(require,module,exports) {
module.exports = "/a91fcd2f08a063621618b52b9eb972b7.png";
},{}],"../src/data/ToolData.js":[function(require,module,exports) {
"use strict";
...
var _aws = _interopRequireDefault(require("../assets/aws.png"));

var _slack = _interopRequireDefault(require("../assets/slack.jpg"));

var _react = _interopRequireDefault(require("../assets/react.png"));

var _postman = _interopRequireDefault(require("../assets/postman.png"));

var _namecheap = _interopRequireDefault(require("../assets/namecheap.png"));

var _gitlab = _interopRequireDefault(require("../assets/gitlab.png"));
...
var _default = [{
  ...
  image: _postman.default
}, {
  index: 4,
  name: "NameCheap",
  purpose: "Domain name acquisition.",
  image: _namecheap.default
}, {
  index: 5,
  name: "GitLab",
  purpose: "Version control and code sharing.",
  image: _gitlab.default
}];
exports.default = _default;
},{"../assets/aws.png":"../src/assets/aws.png","../assets/slack.jpg":"../src/assets/slack.jpg","../assets/react.png":"../src/assets/react.png","../assets/postman.png":"../src/assets/postman.png","../assets/namecheap.png":"../src/assets/namecheap.png","../assets/gitlab.png":"../src/assets/gitlab.png"}],"../src/components/ToolCard.js":[function(require,module,exports) {
"use strict";
...
var _ToolData = _interopRequireDefault(require("../data/ToolData"));
...
/*#__PURE__*/
function (_Component) {
  _inherits(ToolCard, _Component);

  function ToolCard() {
    _classCallCheck(this, ToolCard);

    return _possibleConstructorReturn(this, _getPrototypeOf(ToolCard).apply(this, arguments));
  }

  _createClass(ToolCard, [{
    key: "render",
    value: function render() {
      var toolList = _ToolData.default.map(function (tool) {
        return _react.default.createElement("div", {
          className: "col-md-4",
          key: tool.index
        }, _react.default.createElement("div", {
          ...
          className: "card-body"
        }, _react.default.createElement("h5", null, tool.name), _react.default.createElement("p", null, _react.default.createElement("p", {
          className: "card-text"
        }, tool.purpose)), _react.default.createElement("div", {
          className: "d-flex justify-content-between align-items-center"
        }, _react.default.createElement("div", {
          className: "btn-group"
        })))));
...
var _default = ToolCard;
exports.default = _default;
},{"react":"../node_modules/react/index.js","../data/ToolData":"../src/data/ToolData.js"}],"../src/assets/propublica.jpg":[function(require,module,exports) {
module.exports = "/26a168c78382c70cbbd8aa325b46d948.jpg";
},{}],"../src/assets/sunlight.jpg":[function(require,module,exports) {
module.exports = "/d222e5c71e31c8ebb6bdb4f981da8e06.jpg";
},{}],"../src/assets/google.png":[function(require,module,exports) {
module.exports = "/1b0c51844ca4d1e4eaa170dc64277b9b.png";
},{}],"../src/data/SourceData.js":[function(require,module,exports) {
"use strict";
...
var _propublica = _interopRequireDefault(require("../assets/propublica.jpg"));

var _sunlight = _interopRequireDefault(require("../assets/sunlight.jpg"));
...
exports.default = _default;
},{"../assets/propublica.jpg":"../src/assets/propublica.jpg","../assets/sunlight.jpg":"../src/assets/sunlight.jpg","../assets/google.png":"../src/assets/google.png"}],"../src/components/SourceCard.js":[function(require,module,exports) {
"use strict";
...
var _SourceData = _interopRequireDefault(require("../data/SourceData"));
...
/*#__PURE__*/
function (_Component) {
  _inherits(SourceCard, _Component);

  function SourceCard() {
    _classCallCheck(this, SourceCard);

    return _possibleConstructorReturn(this, _getPrototypeOf(SourceCard).apply(this, arguments));
  }

  _createClass(SourceCard, [{
    key: "render",
    value: function render() {
      var sourceList = _SourceData.default.map(function (source) {
        return _react.default.createElement("div", {
          className: "col-md-4",
          key: source.index
        }, _react.default.createElement("div", {
          ...
          href: source.url
        }, source.name)), _react.default.createElement("p", null, _react.default.createElement("p", {
          className: "card-text"
        }, source.purpose)), _react.default.createElement("div", {
          className: "d-flex justify-content-between align-items-center"
        }, _react.default.createElement("div", {
          className: "btn-group"
        })))));
...
var _default = SourceCard;
exports.default = _default;
},{"react":"../node_modules/react/index.js","../data/SourceData":"../src/data/SourceData.js"}],"../src/About.js":[function(require,module,exports) {
"use strict";
...
var _AboutCard = _interopRequireDefault(require("./components/AboutCard"));

var _ToolCard = _interopRequireDefault(require("./components/ToolCard"));

var _SourceCard = _interopRequireDefault(require("./components/SourceCard"));
...
function About() {
  ...
  }, "Meet the Team"), _react.default.createElement("p", {
    className: "lead text-muted"
  }, "Get to know the team responsible for creating and maintaining this site!"))), _react.default.createElement("div", {
  ...
  }, "Our Purpose"), _react.default.createElement("div", {
    className: "row",
    style: {
      marginBottom: "3%"
    }
  ...
  }, "Our website shows the topics that members of Congress discuss and avoid based on their Tweets as well as speeches given before Congress. It helps users by allowing them to see which issues are represented in their home state and which ones should be lobbied for in regards to being addressed. This website will also highlight which issues on a nation-wide scale are being discussed and which ones require attention.")), _react.default.createElement("div", {
    className: "col-md-3"
  })), _react.default.createElement(_AboutCard.default, null), _react.default.createElement("h3", {
    className: "text-center",
    style: {
      marginTop: "3%",
      marginBottom: "3%"
    }
  }, "Tools"), _react.default.createElement(_ToolCard.default, null), _react.default.createElement("h3", {
    className: "text-center",
    style: {
      marginTop: "3%",
      marginBottom: "3%"
    }
  }, "Data Sources"), _react.default.createElement(_SourceCard.default, null), _react.default.createElement("h3", {
    className: "text-center",
    style: {
      marginBottom: "3%"
    }
  }, "Links"), _react.default.createElement("p", {
    className: "text-center"
  }, _react.default.createElement("a", {
    href: "https://gitlab.com/AbuZaydAbdullah/congressconversation"
  }, "GitLab Repository")), _react.default.createElement("p", {
    className: "text-center"
  }, _react.default.createElement("a", {
    href: "https://documenter.getpostman.com/view/9014793/SVzxXyvM?version=latest"
  }, "API Documentation"))));
}

var _default = About;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./components/AboutCard":"../src/components/AboutCard.js","./components/ToolCard":"../src/components/ToolCard.js","./components/SourceCard":"../src/components/SourceCard.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/About.js"], null)
//# sourceMappingURL=/src/About.js.map