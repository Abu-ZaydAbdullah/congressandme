...
manager.create_api(megaTable, methods = ['GET'], max_results_per_page=540)
manager.create_api(stateIssues, methods = ['GET'], max_results_per_page=540)
manager.create_api(Tweets, methods = ['GET'], max_results_per_page=2000)
